        ...
        <div className='relative top-0 w-full'>
            ...
            <div className='mt-4 sm:mt-0 px-5 sm:px-12 py-6 sm:py-12  flex flex-col'>
                <div className='flex flex-col gap-y-4 sm:gap-y-8'>
                    ...
                    <div className='mt-4 flex-col sm:flex-row flex items-start gap-y-3 sm:gap-y-0 sm:items-center gap-x-4 w-full'>
                        <Link to='/ad-launch/alex' className='w-full sm:w-max'><div className='hover:border-[#FDCA40] transition-all h-24  flex justify-center items-center p-6 rounded-2xl border border-[#3B3B3B]'>
                            <div className='flex items-center gap-x-3 text-2xl text-[#dbdbdb]'>Alex <Link1 size="28" color="#FDCA40"/></div>
                        </div></Link>

                        <Link to='/ad-launch/meri' className='w-full sm:w-max'><div className='hover:border-[#FDCA40] transition-all h-24 flex justify-center items-center p-6 rounded-2xl border border-[#3B3B3B]'>
                            <div className='flex items-center gap-x-3 text-2xl text-[#dbdbdb]'>Meri <Link1 size="28" color="#FDCA40"/></div>
                        </div></Link>

                        <Link to='/ad-launch/danyal' className='w-full sm:w-max'><div className='hover:border-[#FDCA40] transition-all h-24 flex justify-center items-center p-6 rounded-2xl border border-[#3B3B3B]'>
                            <div className='flex items-center gap-x-3 text-2xl text-[#dbdbdb]'>Danyal  <Link1 size="28" color="#FDCA40"/></div>
                        </div></Link>
